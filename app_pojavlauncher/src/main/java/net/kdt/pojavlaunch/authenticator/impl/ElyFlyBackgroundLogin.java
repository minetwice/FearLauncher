...
public class ElyFlyBackgroundLogin implements BackgroundLogin {
    public static final BackgroundLogin.Creator CREATOR = ElyFlyBackgroundLogin::new;
    ...
    private void acquireAccountDetails(
        ...
        sExecutorService.execute(() -> {
            ...
            try {
                ...
                Log.e("ElyFlyAuth", "Exception thrown during authentication", e);
    ...
    private void acquireTokens(boolean isRefresh, String code) throws IOException {
        ...
        Log.i("ElyFlyLogin", "isRefresh=" + isRefresh + ", authCode= "+code);
