...
public class MainMenuFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        View modpacksBtn = view.findViewById(R.id.main_modpacks_btn);
        View addonsBtn = view.findViewById(R.id.main_addons_btn);

        if (modpacksBtn != null) {
            modpacksBtn.setOnClickListener(v -> {
                v.playSoundEffect(android.view.SoundEffectConstants.CLICK);
                net.kdt.pojavlaunch.SoundManager.playClick();
                Bundle bundle = new Bundle();
                bundle.putString("mode", "modpack");
                net.kdt.pojavlaunch.Tools.swapFragment(requireActivity(), SearchModFragment.class, SearchModFragment.TAG, bundle);
            });
        }

        if (addonsBtn != null) {
            addonsBtn.setOnClickListener(v -> {
                v.playSoundEffect(android.view.SoundEffectConstants.CLICK);
                net.kdt.pojavlaunch.SoundManager.playClick();
                Bundle bundle = new Bundle();
