...
public class GameRunner {
    ...
    public static void launchMinecraft(final AppCompatActivity activity, MinecraftAccount minecraftAccount,
        ...
        boolean isLtw = rendererName.equals("opengles3_ltw") || rendererName.equals("fear_engine") || rendererName.equals("mh_drive") || rendererName.equals("quasar");
        ...
        String glLibName = rendererLibrary;
        int slash = glLibName.lastIndexOf('/');
        if (slash >= 0) glLibName = glLibName.substring(slash + 1);
        javaArgList.add("-Dorg.lwjgl.opengl.libname=" + glLibName);
        ...
        if (rendererName.equals("fear_engine") || rendererName.equals("mh_drive") || rendererName.equals("opengles3_ltw") || rendererName.equals("quasar")) {
            try {
        ...
        if (useLocalServer) {
            ...
            if (!injectorJar.exists()) {
                try {
                    ...
                    Log.e("LocalSkinServer", "Failed to extract authlib-injector.jar", e);
                }
            }
            if (injectorJar.exists()) {
                try {
                    ...
                    Log.e("LocalSkinServer", "Error starting local skin server", e);
                }
            }
            return;
        }
    ...
    private static List<String> splitAndFilterEmpty(String argStr) {
        ...
        for (String arg : argStr.split(" ")) {
            if (!arg.isEmpty()) strList.add(arg);
        }
        return strList;
    }
