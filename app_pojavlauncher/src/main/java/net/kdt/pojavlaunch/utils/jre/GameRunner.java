...
public class GameRunner {
    ...
    public static void launchMinecraft(final AppCompatActivity activity, MinecraftAccount minecraftAccount,
        ...
        // Zink renderers use Mesa NIR compiler (deep recursion during shader
        // compilation) and Zink/Vulkan init, which needs far more stack than
        // the JVM default (1-2MB on aarch64). Without this, SIGSEGV occurs in
        // Mesa internals (e.g. strtoul) due to stack overflow on render thread.
