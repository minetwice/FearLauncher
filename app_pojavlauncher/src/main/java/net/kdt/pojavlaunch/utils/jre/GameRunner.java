...
public class GameRunner {
    ...
    public static void launchMinecraft(final AppCompatActivity activity, MinecraftAccount minecraftAccount,
        ...
        boolean isLtw = rendererName.equals("opengles3_ltw") || rendererName.startsWith("turbo");
        ...
        javaArgList.add("-Dorg.lwjgl.opengl.libname=" + (rendererName.startsWith("turbo") ? "libTurboV1.so" : "libGL.so"));
