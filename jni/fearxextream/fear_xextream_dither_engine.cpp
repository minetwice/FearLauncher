            ...
            if (mainPos != std::string::npos) {
                ...
                if (openBrace != std::string::npos) {
                    ...
                    if (mainEndPos != std::string::npos) {
                        ...
                        if (shaderSource.find("out vec4 fear_FragColor;") != std::string::npos) {
                        ...
                        } else if (shaderSource.find("out vec4 fear_FragData0;") != std::string::npos) {
                        ...
                        } else if (shaderSource.find("out vec4 FragColor;") != std::string::npos) {
